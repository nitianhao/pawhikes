/**
 * Displays all trail system fields whose key starts with "winter" in raw format.
 * Data is passed from the trail page (filtered from the system object).
 */
type WinterRawSectionProps = {
...
export function WinterRawSection({ data }: WinterRawSectionProps) {
  ...
  return (
    <section style={S.section}>
      <h2 style={S.title}>Winter (raw)</h2>
      <p style={S.subtitle}>All DB fields starting with &quot;winter&quot;</p>
      <div style={S.content}>
