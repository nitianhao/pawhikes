/**
 * Displays all trail system fields whose key starts with "swim" in raw format.
 * Data is passed from the trail page (filtered from the system object).
 */
type SwimRawSectionProps = {
...
export function SwimRawSection({ data }: SwimRawSectionProps) {
  ...
  return (
    <section style={S.section}>
      <h2 style={S.title}>Swim (raw)</h2>
      <p style={S.subtitle}>All DB fields starting with &quot;swim&quot;</p>
      <div style={S.content}>
