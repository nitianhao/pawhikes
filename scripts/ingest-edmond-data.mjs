#!/usr/bin/env node
/**
 * Ingest Edmond, OK trail segments from OpenStreetMap via Overpass API.
...
// Edmond, OK bbox: S,W,N,E — covers Mitch Park, Hafer Park, water tower trails
const CITY_BBOX = "35.60,-97.55,35.75,-97.35";
const CITY_NAME = "Edmond";
const CITY_STATE = "OK";
const CITY_COUNTY = "Oklahoma";
const EXT_DATASET = "edmond_osm";
...
const TRAIL_INDICATORS = /\b(trail|trails|greenway|greenways|path|hike|bikeway|corridor|lake|creek|river|park)\b/i;
...
async function fetchOSMTrails() {
  const trailNameRegex = "trail|trails|greenway|greenways|hike|bikeway|corridor|lake|creek|river|park";
  const query = [
