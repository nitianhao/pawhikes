#!/usr/bin/env node
/**
 * Ingest Norman, OK trail segments from OpenStreetMap via Overpass API.
 * Writes into: trailSystems, trailSegments.
 *
 * Data source: OpenStreetMap via Overpass API
 *   Query: named footway/path/cycleway/track/bridleway ways in Norman bbox
 */
...
// Norman, OK bbox: S,W,N,E — covers University of Oklahoma trails, Thunderbird Lake area
const CITY_BBOX = "35.15,-97.55,35.30,-97.35";
const CITY_NAME = "Norman";
const CITY_STATE = "OK";
const CITY_COUNTY = "Cleveland";
const EXT_DATASET = "norman_osm";
...
const TRAIL_INDICATORS = /\b(trail|trails|greenway|greenways|path|hike|bikeway|corridor|lake|creek|river)\b/i;
...
const NORMALIZE_NAMES = new Map([
  // Add any Norman-specific name normalizations here as discovered
]);
...
async function fetchOSMTrails() {
  const trailNameRegex = "trail|trails|greenway|greenways|hike|bikeway|corridor|lake|creek|river";
  const query = [
