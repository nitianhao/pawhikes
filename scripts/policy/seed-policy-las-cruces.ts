#!/usr/bin/env npx tsx
/**
 * Seed official dog policy fields onto Las Cruces, NM trailSystems.
 * DRY RUN by default — no DB writes until --commit is passed.
 * Usage: npx tsx scripts/policy/seed-policy-las-cruces.ts [--commit]
 */
...
const DEFAULT_POLICY: Policy = {
  ...
  leashDetails: "Dogs must be on leash in Las Cruces city parks and trail corridors. Las Cruces Municipal Code §26-35.",
  policySourceUrl: "https://www.las-cruces.org/departments/parks-recreation",
  policySourceTitle: "Parks and Recreation | City of Las Cruces",
  policyConfidence: 0.75,
  policyMethod: "manual_seed",
  policyNotes: "Las Cruces Municipal Code §26-35 requires leash at all times in city parks and trails.",
};

async function main(): Promise<void> {
  console.log("=== seed-policy-las-cruces ===");
