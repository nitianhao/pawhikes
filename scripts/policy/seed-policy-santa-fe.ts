#!/usr/bin/env npx tsx
/**
 * Seed official dog policy fields onto Santa Fe, NM trailSystems.
 * DRY RUN by default — no DB writes until --commit is passed.
 * Usage: npx tsx scripts/policy/seed-policy-santa-fe.ts [--commit]
 */
...
const DEFAULT_POLICY: Policy = {
  ...
  leashDetails: "Dogs must be on leash in Santa Fe city parks and trail corridors. Santa Fe City Code §22-1.",
  policySourceUrl: "https://www.santafenm.gov/parks_and_recreation",
  policySourceTitle: "Parks and Recreation | City of Santa Fe",
  policyConfidence: 0.75,
  policyMethod: "manual_seed",
  policyNotes: "Santa Fe City Code §22-1 requires leash at all times in city parks and trails.",
};

async function main(): Promise<void> {
  console.log("=== seed-policy-santa-fe ===");
