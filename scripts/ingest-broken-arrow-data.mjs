#!/usr/bin/env node
/**
 * Ingest Broken Arrow, OK trail segments from OpenStreetMap via Overpass API.
...
// Broken Arrow, OK bbox: S,W,N,E — SE suburb of Tulsa
const CITY_BBOX = "35.95,-95.90,36.15,-95.65";
const CITY_NAME = "Broken Arrow";
const CITY_STATE = "OK";
const CITY_COUNTY = "Tulsa";
const EXT_DATASET = "broken_arrow_osm";
