#!/usr/bin/env node
/**
 * Push schema with renames: *Id -> *Key on austinTrailSegments so Instant stops treating them as links.
 */
...
const args = [
  ...
  appId,
  "--rename",
  "austinTrailSegments.sourceObjectId:austinTrailSegments.sourceObjectKey",
  "--rename",
  "austinTrailSegments.sourceNetworkId:austinTrailSegments.sourceNetworkKey",
  "--rename",
  "austinTrailSegments.trailSystemId:austinTrailSegments.trailSystemKey",
  "--yes",
];
